...
function updateautoInsurance() {
    ...
    useEffect(()=>{{
      ...
      const Update= (e) =>{
        e.preventDefault();
        axios.put("http://localhost:3000/autoinsurance/updateautoinsurance/"+id,{insurance_name, coverage_type,description,coverage_limit,premium_rate})
        .then(result => {
          console.log(result)
...
export default updateautoInsurance
